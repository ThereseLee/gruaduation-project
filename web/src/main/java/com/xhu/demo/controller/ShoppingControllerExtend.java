...
import com.xhu.demo.bean.Commodity;
import com.xhu.demo.bean.CommodityType;
import com.xhu.demo.bean.Customer;
import com.xhu.demo.service.ProductAndUserService;
import com.xhu.demo.service.ProductService;
import com.xhu.demo.service.UserService;
import com.xhu.demo.utils.IPTimeStamp;
import com.xhu.demo.utils.UserUtils;
...
public class ShoppingControllerExtend {
    ...
    public String sell(Commodity commodity, @RequestParam("file") MultipartFile file, HttpSession session, Model model) throws Exception {
        ...
        if(!file.isEmpty() && file.getSize() > 0){
            ...
            file.transferTo(new File("E:\\workspace idea\\gruaduation-project\\web\\src\\main\\resources\\static\\images\\" + fileName));
